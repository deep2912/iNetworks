...
<div class="wrapper row2">
  <div id="container" class="clear">
    ...
    <div id="homepage">
	  ...
	  <h1>ISR 800 Series</h1>
	  <img src="images/demo/isr_800.jpg" width="280" height="280" alt="">
...
<table>
  ...
  <tr>
    ...
    <td>2.4 and 5 GHz</td>
	 ...
	 <center> <form method="post" action="cart.php?action=add&code=isr_800" target="_blank">
